...
function [out, outp] = ms(vfun, vt, vinit, vinitp,ep,g ,opt);
...
for i = 1+nt0:nt,
	...
	Err = 1.e+18;
	Iter = 0;
    W=1/h*ep*(sqrt(h)*normrnd(0,1)); % stochastic input with a coefficient 1000*ep to acive the same results of Euler Mar
	while (1)
